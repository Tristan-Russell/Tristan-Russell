...
<body onload="hideElements()" style="background-color: #ffffff;background-image: url(&quot;assets/img/2312673.jpg&quot;);">
    ...
    <img src="assets/img/Picture12.png" style="height: 156px;margin-left: 15px;margin-top: 10px;" onclick="imageClick()">
    <form method="POST" >
    <nav class="navbar navbar-light navbar-expand-md navigation-button" style="margin-right: 20px;margin-left: 250px;margin-top: -125px;background-color: rgba(255,255,255,0.49);height: 50px;width: auto;">
    ...
    <div id="register" class="register-photo" style="background-color: rgba(241,247,252,0);">
        <div class="form-container">
            <form action ="register.php" method="POST" style="background-color: #dddddd;">
                ...
                </div><a class="already" onclick="showLogin()">You already have an account? Login here.</a>
            </form>
        </div>
    </div>
    ...
    <div id="login" class="login" style="background-color: rgba(241,247,252,0); ">
        <form action ="Login.php" method="post" style="background-color: rgb(221,221,221);">
            ...
            </div><a class="forgot" href="Contact Us.php">Forgot your email or password? Log A Ticket with Us!</a>
        </form>
    </div>

    <div id="products" class="row" style="margin-top: 100px;height: 500px;margin-right: 10px;margin-left: 100px;">
